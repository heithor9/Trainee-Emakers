...
public class PessoaController {
    ...
    public ResponseEntity<PessoaResponseDTO> buscarPessoaPorId(Long idPessoa) {
        return ResponseEntity.status(HttpStatus.OK).body(pessoaService.buscarPessoaPorId(idPessoa));
    }

    @PostMapping(value = "/create")
    public ResponseEntity<PessoaResponseDTO> adicionarNovaPessoa (@RequestBody PessoaRequestDTO pessoaRequestDTO) {
    ...
    public ResponseEntity<PessoaResponseDTO> atualizarPessoa(@PathVariable Long idPessoa,@RequestBody PessoaRequestDTO pessoaRequestDTO) {
